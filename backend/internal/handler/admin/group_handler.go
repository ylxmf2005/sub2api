...
type CreateGroupRequest struct {
	...
	SubscriptionType string             `json:"subscription_type" binding:"omitempty,oneof=standard subscription settlement_pool"`
	...
	SupplySelfServiceReviewPolicy string   `json:"supply_self_service_review_policy" binding:"omitempty,oneof=manual_review auto_online"`
	// 从指定分组复制账号（创建后自动绑定）
...
func (h *GroupHandler) Create(c *gin.Context) {
	...
	group, err := h.adminService.CreateGroup(c.Request.Context(), &service.CreateGroupInput{
		...
		SupplyRewardsEnabled:            req.SupplyRewardsEnabled,
		SupplyRewardMultiplier:          req.SupplyRewardMultiplier,
		SupplySelfServiceReviewPolicy:   req.SupplySelfServiceReviewPolicy,

...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		RPMLimit:                        g.RPMLimit,
		SupplyRewardsEnabled:            g.SupplyRewardsEnabled,
		SupplyRewardMultiplier:          g.SupplyRewardMultiplier,
		SupplySelfServiceReviewPolicy:   g.SupplySelfServiceReviewPolicy,
...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		SupplyOwnerUserID:       a.SupplyOwnerUserID,
		SupplySource:            a.SupplySource,
		SupplyStatus:            a.SupplyStatus,
		SupplyStatusReason:      a.SupplyStatusReason,
		SupplySubmittedBy:       a.SupplySubmittedBy,
		SupplyReviewedBy:        a.SupplyReviewedBy,
		SupplyReviewedAt:        a.SupplyReviewedAt,

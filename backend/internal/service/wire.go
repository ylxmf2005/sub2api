...
func ProvideAPIKeyService(
	...
	settlementPoolRepository SettlementPoolRepository,
) *APIKeyService {
	svc := NewAPIKeyService(apiKeyRepo, userRepo, groupRepo, userSubRepo, userGroupRateRepo, cache, cfg, settlementPoolRepository)

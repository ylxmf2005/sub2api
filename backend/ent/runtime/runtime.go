...
func init() {
	...
	groupDescSupplyRewardsEnabled := groupFields[31].Descriptor()
	...
	groupDescSupplyRewardMultiplier := groupFields[32].Descriptor()
	...
	groupDescSupplySelfServiceReviewPolicy := groupFields[33].Descriptor()

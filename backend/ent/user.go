...
type UserEdges struct {
	...
	// ResourceSupplyBalance holds the value of the resource_supply_balance edge.
	ResourceSupplyBalance []*ResourceSupplyBalance `json:"resource_supply_balance,omitempty"`
...
// ResourceSupplyBalanceOrErr returns the ResourceSupplyBalance value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) ResourceSupplyBalanceOrErr() ([]*ResourceSupplyBalance, error) {
	if e.loadedTypes[12] {
		return e.ResourceSupplyBalance, nil
	}
	return nil, &NotLoadedError{edge: "resource_supply_balance"}
}
...
// QueryResourceSupplyBalance queries the "resource_supply_balance" edge of the User entity.
func (_m *User) QueryResourceSupplyBalance() *ResourceSupplyBalanceQuery {
	return NewUserClient(_m.config).QueryResourceSupplyBalance(_m)
}

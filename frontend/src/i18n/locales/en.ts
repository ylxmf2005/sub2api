export default {
  ...
  settlementPools: {
    ...
    adminDescription: 'Configure pool parameters, manage participants, and lock cycle snapshots.',
    userTitle: 'Settlement Pools',
    userDescription: 'See your current estimate, public parameters, and historical cycles.',

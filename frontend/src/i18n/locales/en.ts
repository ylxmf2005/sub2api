export default {
  ...
  nav: {
    ...
    resourceSupply: 'Resource Supply',
    profile: 'Profile',
    users: 'Users',
    groups: 'Groups',
    channels: 'Channels',
    ...
    settlementPools: 'Settlement Pools'
  },

  settlementPools: {
    adminTitle: 'Settlement Pools',
    adminDescription: 'Configure pool parameters, manage candidate eligibility and current-cycle participants, and lock cycle snapshots.',
    userTitle: 'Settlement Pools',
    userDescription: 'See eligible settlement pools, current estimates, public parameters, and historical cycles.',
    noGroups: 'No settlement pool groups yet',
    noGroupsDesc: 'Create a group as a settlement pool first, then configure it here.',
    noJoinedPools: 'No eligible settlement pools yet',
    noJoinedPoolsDesc: 'Eligible pools will appear here when an admin grants access.',
    pool: 'Pool',
    parameters: 'Parameters',
    currentEstimate: 'Current Estimate',
    publicParameters: 'Public Parameters',
    totalCost: 'Total Cost',
    totalCostShort: 'Total Cost C',
    baseRatio: 'Base Ratio',
    marketCap: 'Market Cap l',
    tiers: 'Tiers',
    candidates: 'Long-term Candidates',
    ...
    notJoinedCurrentCycle: 'Not Joined Current Cycle',
    forceJoin: 'Join Cycle',
    user: 'User',
    rawUsage: 'Raw Usage',
    weightedUsage: 'Weighted Usage',
    currentTier: 'Current Tier',
    fixedShare: 'Fixed Share',
    dynamicCharge: 'Dynamic Charge',
    totalDue: 'Estimated Due',
    dynamicRate: 'Effective Dynamic Rate',
    uncappedDynamicRate: 'Uncapped Dynamic Rate',
    fixedPool: 'Fixed Pool',
    dynamicPool: 'Dynamic Pool',
    ownerLoss: 'Owner Covered Loss',
    myDue: 'My Estimated Due',
    myUsage: 'My Raw Usage',
    myFixedShare: 'My Fixed Share',
    myDynamicCharge: 'My Dynamic Charge',
    noActiveEstimate: 'There is no live estimate to show yet.',
    noCycles: 'No historical cycles yet',
    ...
    startConfirm: 'Starting a new cycle will lock the current active cycle into a historical snapshot.',
    failedToLoad: 'Failed to load settlement pools',
    failedToSave: 'Failed to save settlement pool',
    failedToJoin: 'Failed to join current cycle',
    saved: 'Settlement pool saved',
    cycleStarted: 'New cycle started',
    status: {
      active: 'Active',
      locked: 'Locked',
      history: 'History'
  ...
  resourceSupply: {
    ...
    stats: {
      ...
      lifetimeTransferred: 'Total Transferred',
      accounts: 'Supply Accounts',
    },
    transfer: {
      title: 'Transfer to Balance',
      description: 'Transfer available supply earnings to your main balance for site-wide spending',
      button: 'Transfer to Balance',
      transferring: 'Transferring...',
      empty: 'No supply earnings available to transfer',
    ...
    submit: {
      ...
      groupId: 'Group ID',
      groupIdPlaceholder: 'Target group ID',
      groupPlaceholder: 'Select a rewarded OpenAI group',
      noGroups: 'No available OpenAI group has supply rewards enabled.',
      groupsLoadFailed: 'Failed to load available groups',
      name: 'Account Name',
      namePlaceholder: 'Optional, auto-generated if empty',
      modelId: 'Model ID',
      modelIdPlaceholder: 'Optional, for example gpt-4o',
      modelIdHint: 'Optional model identifier used by the rewarded supply group.',
      submitApiKey: 'Submit API Key',
      generateOAuthUrl: 'Generate OAuth URL',
      oauthUrlReady: 'Authorization URL is ready. Complete authorization in the new window:',
      openOAuthWindow: 'Open Authorization Page',
      oauthCode: 'Authorization Code',
      oauthCodePlaceholder: 'Enter the code from the authorization callback',
      exchangeOAuth: 'Submit OAuth Account',
      success: 'Account submitted successfully',
      failed: 'Account submission failed',
    },
    accounts: {
      title: 'My Supply Accounts',
      empty: 'No supply accounts',
      pause: 'Pause',
      revoke: 'Revoke',
      pauseSuccess: 'Account paused',
      revokeSuccess: 'Account revoked',
  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        supplyRewards: 'Supply Rewards',
        supplyRewardsEnabled: 'Enable Supply Rewards',
        supplyRewardsEnabledOn: 'Enabled — requests in this group generate supply rewards',
        supplyRewardsEnabledOff: 'Disabled',
        supplyRewardMultiplier: 'Reward Multiplier (k)',
        supplyRewardMultiplierHint: 'Supply reward = actual_cost × k, default 1.0',
        supplyReviewPolicy: 'Self-Service Review Policy',
        reviewPolicyManual: 'Manual Review',
        reviewPolicyAutoOnline: 'Auto-Online After Test',
        supplyReviewPolicyHint: 'Controls what happens after a user-submitted account passes testing',
      },
      ...
      subscription: {
        ...
        type: 'Billing Type',
        typeHint:
          'Standard deducts balance, subscription uses quotas, and settlement pools allocate by cycle.',
    ...
    accounts: {
      ...
      columns: {
        ...
        expiresAt: 'Expires At',
        actions: 'Actions',
        supplyOwner: 'Supply Owner',
        supplyStatus: 'Supply Status'
      },
      resourceSupplyActions: {
        approve: 'Approve',
        reject: 'Reject',
        pause: 'Pause',
        resume: 'Resume',
        approveReason: 'Approved by admin',
        rejectReason: 'Rejected by admin',
        pauseReason: 'Paused by admin',
        resumeReason: 'Resumed by admin',
        approveSuccess: 'Supply account approved',
        rejectSuccess: 'Supply account rejected',
        pauseSuccess: 'Supply account paused',
        resumeSuccess: 'Supply account resumed',
        approveFailed: 'Failed to approve supply account',
        rejectFailed: 'Failed to reject supply account',
        pauseFailed: 'Failed to pause supply account',
        resumeFailed: 'Failed to resume supply account'
      },
    ...
    settings: {
      ...
      features: {
        ...
        resourceSupply: {
          title: 'Resource Supply',
          description: 'Allow users to self-service submit OpenAI accounts and earn supply credit. Disabled by default.',
          enabled: 'Enable User Self-Service Intake',
          enabledHint: 'When off, users cannot submit new accounts, but existing supply balances and ledger remain accessible. Admin binding is unaffected.',
        },
      },

export default {
  ...
  settlementPools: {
    ...
    adminDescription: 'Maintain cycle costs, tier weights, and participants.',
    userTitle: 'Settlement Pools',
    userDescription: 'View live allocation and locked cycle history.',
    pool: 'Pool',
    totalCost: 'Total Cost',
    dynamicRate: 'Dynamic Rate',
    participants: 'Participants',
    ownerLoss: 'Owner Loss',
    startNextCycle: 'Start Cycle',
    ...
    noGroups: 'No settlement pool groups',
    noGroupsDesc: 'Create a settlement pool billing group in group management first.',
    noJoinedPools: 'No joined settlement pools',
    noJoinedPoolsDesc: 'Pools will appear here after an admin adds you.',
    myDue: 'My Due',
    myUsage: 'My Usage',
    noActiveEstimate: 'No active estimate',
    noCycles: 'No cycle history',
    failedToLoad: 'Failed to load settlement pools',
    failedToSave: 'Failed to save settlement pool',
    saved: 'Saved',
    startConfirm: 'Start a new cycle? The current cycle will be locked.',

export default {
  ...
  settlementPools: {
    adminTitle: '结算池',
    adminDescription: '维护周期成本、阶梯倍率和参与用户。',
    userTitle: '结算池',
    userDescription: '查看当前周期的实时分摊和历史结算。',
    pool: '池',
    totalCost: '总成本',
    dynamicRate: '动态单价',
    participants: '参与用户',
    ownerLoss: '兜底亏损',
    startNextCycle: '开启新周期',
    parameters: '参数',
    totalCostShort: '成本',
    baseRatio: '占坑比例',
    marketCap: '市场上限',
    ...
    noGroups: '暂无结算池分组',
    noGroupsDesc: '先在分组管理里创建结算池计费分组。',
    noJoinedPools: '暂无参与的结算池',
    noJoinedPoolsDesc: '管理员加入后会在这里显示实时分摊。',
    myDue: '我的应付',
    myUsage: '我的用量',
    noActiveEstimate: '暂无当前预估',
    noCycles: '暂无历史周期',
    failedToLoad: '加载结算池失败',
    failedToSave: '保存结算池失败',
    saved: '已保存',
    startConfirm: '确定要开启新周期吗？当前周期会被锁定。',
    cycleStarted: '新周期已开启'
  },

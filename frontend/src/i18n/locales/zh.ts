export default {
  ...
  settlementPools: {
    adminTitle: '结算池管理',
    adminDescription: '配置参数、维护候选资格和当前周期参与者，并锁定周期快照。',
    userTitle: '结算池',
    userDescription: '查看你有资格加入的结算池当前预估、公开参数和历史周期。',
    noGroups: '暂无结算池分组',
    noGroupsDesc: '先把分组创建为结算池类型，再来这里配置。',
    noJoinedPools: '暂无可加入的结算池',
    noJoinedPoolsDesc: '获得候选资格后，这里会显示可查看和加入的结算池。',
    pool: '结算池',
    parameters: '配置参数',
    currentEstimate: '当前预估',
    publicParameters: '公开参数',
    totalCost: '总成本',
    totalCostShort: '总成本 C',
    baseRatio: '基础比例',
    marketCap: '市场封顶价 l',
    tiers: '阶梯',
    candidates: '长期候选',
    noCandidates: '暂无候选用户',
    currentParticipants: '当前周期参与者',
    participants: '参与者',
    accountUsage: '本周期账号用量',
    accountUsagePeriod: '结算周期：{period}',
    joinCurrentCycle: '加入当前周期',
    joiningCurrentCycle: '加入中...',
    joinedCurrentCycle: '已加入当前周期',
    notJoinedCurrentCycle: '未加入当前周期',
    forceJoin: '加入本周期',
    user: '用户',
    account: '账号',
    requests: '请求数',
    ...
    rawUsage: '原始用量',
    manualUsage: '手动登记',
    manualUsageUser: '登记用户',
    manualUsageUserPlaceholder: '选择当前周期参与者',
    manualUsageAccount: '归属账号',
    manualUsageAccountPlaceholder: '选择本结算池账号',
    manualUsageAmount: '调整用量',
    manualUsageReason: '备注',
    manualUsageReasonPlaceholder: '例如：绕过中转站使用账号 / 冲正误登记',
    manualUsageAdjustments: '手动调整记录',
    addManualUsage: '调整用量',
    manualUsageAdded: '已调整用量',
    failedToAddManualUsage: '调整用量失败',
    noManualUsageAdjustments: '暂无手动登记记录',
    weightedUsage: '折算用量',
    currentTier: '当前阶梯',
    fixedShare: '固定分摊',
    dynamicCharge: '动态费用',
    ...
    myUsage: '我的原始用量',
    myFixedShare: '我的固定分摊',
    myDynamicCharge: '我的动态费用',
    noActiveEstimate: '当前还没有可展示的实时预估。',
    noCycles: '暂无历史周期',
    noParticipants: '暂无参与者',
    noAccountUsage: '当前周期暂无开启账号。',
    cycles: '周期',
    period: '周期区间',
    createdAt: '创建时间',
    searchUser: '搜索用户',
    unlimited: '无上限',
    startNextCycle: '开始下一个周期',
    startConfirm: '开始新周期后，当前活跃周期会被锁定并生成历史快照。',
    failedToLoad: '加载结算池失败',
    failedToSave: '保存结算池失败',
    failedToJoin: '加入当前周期失败',
    saved: '结算池已保存',
    cycleStarted: '已开始新周期',
    status: {
      active: '活跃周期',
  ...
  resourceSupply: {
    title: '资源供给',
    description: '管理资源供给账号，查看收益和流水',
    loadFailed: '加载资源供给数据失败',
    statuses: {
      none: '未供给',
      testing: '测试中',
      pending_review: '待审核',
    ...
    statusDescriptions: {
      none: '该账号尚未绑定供给主人，不会产生供给收益。',
      testing: '系统正在验证账号可用性，验证完成后会进入审核或供给状态。',
      pending_review: '账号已提交，等待管理员审核通过后才会参与调度并产生收益。',
      schedulable: '账号已通过审核并参与调度，被使用时会给绑定用户结算供给收益。',
      paused: '账号已暂停供给，恢复前不会参与调度，也不会产生新的供给收益。',
      rejected: '账号未通过审核，不会参与调度或产生供给收益。',
      revoked: '账号供给关系已撤回，不会继续参与收益结算。',
      unknown: '系统返回了暂未识别的供给状态，请刷新或联系管理员确认。'
    },
    sources: {
      admin: '管理员绑定',
      self_service: '用户提交'
    ...
    stats: {
      available: '可用收益',
      lifetimeEarned: '累计收益',
      lifetimeTransferred: '已转入余额',
      accounts: '供给账号数',
    },
    transfer: {
      title: '转入余额',
      description: '将可用供给收益转入主余额，转入后可全站消费',
      button: '转入余额',
      transferring: '转入中...',
      empty: '暂无可用供给收益',
      success: '已转入 {amount}',
    ...
    submit: {
      title: '提交账号',
      groupId: '分组 ID',
      groupIdPlaceholder: '目标分组 ID',
      groupPlaceholder: '选择已启用收益的 OpenAI 分组',
      noGroups: '暂无可用且已启用供给收益的 OpenAI 分组',
      groupsLoadFailed: '加载可用分组失败',
      name: '账号名称',
      namePlaceholder: '可选，留空自动生成',
      modelId: 'Model ID',
      modelIdPlaceholder: '可选，例如 gpt-4o',
      modelIdHint: '可选，供给分组用于识别模型的标识。',
      submitApiKey: '提交 API Key',
      generateOAuthUrl: '生成 OAuth 授权链接',
      oauthUrlReady: '授权链接已生成，请在新窗口中完成授权：',
      openOAuthWindow: '打开授权页面',
      oauthCode: '授权码',
      oauthCodePlaceholder: '请输入授权完成后获得的 code',
      exchangeOAuth: '提交 OAuth 账号',
      success: '账号提交成功',
      failed: '账号提交失败',
    },
    accounts: {
  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        supplyRewards: '供给收益配置',
        supplyRewardsEnabled: '启用供给收益',
        supplyRewardsEnabledOn: '已启用 — 该分组的请求会产生供给收益',
        supplyRewardsEnabledOff: '未启用',
        supplyRewardMultiplier: '收益倍率 (k)',
        supplyRewardMultiplierHint: '供给收益 = actual_cost × k，默认 1.0',
        supplyReviewPolicy: '自助接入审核策略',
        reviewPolicyManual: '需要审核',
        reviewPolicyAutoOnline: '测试通过自动上线',
        supplyReviewPolicyHint: '控制用户自助提交的账号测试通过后的处理方式',
        exclusiveLabel: '专属分组',
      ...
      subscription: {
        title: '订阅设置',
        type: '计费类型',
        typeHint: '标准计费扣余额，订阅使用配额，结算池按周期分摊。',
    ...
    accounts: {
      ...
      resourceSupplyActions: {
        ...
        pause: '暂停',
        resume: '恢复',
        approveReason: '管理员已批准',
        rejectReason: '管理员已拒绝',
        pauseReason: '管理员已暂停',
        resumeReason: '管理员已恢复',
        approveSuccess: '供给账号已批准',
        rejectSuccess: '供给账号已拒绝',
        pauseSuccess: '供给账号已暂停',
        resumeSuccess: '供给账号已恢复',
        approveFailed: '批准供给账号失败',
        rejectFailed: '拒绝供给账号失败',
        pauseFailed: '暂停供给账号失败',
        resumeFailed: '恢复供给账号失败',
      },
      ...
      usageWindow: {
        ...
        passiveSampled: '被动采样',
        activeQuery: '查询',
        estimatedTotal: '本周预估可用额度',
        estimatedTotalHint: '按本周已产生费用 ÷ 上游返回的使用百分比估算可用额度'
      },
      tier: {
        free: 'Free',
        pro: 'Pro',
      ...
      form: {
        ...
        supplyOwnerSelectedHint: '该账号被调度时，收益会结算给此用户',
    ...
    settings: {
      ...
      features: {
        ...
        resourceSupply: {
          title: '资源供给',
          description: '允许用户自助提交 OpenAI 账号并获得供给收益。默认关闭。',
          enabled: '启用用户自助接入',
          enabledHint: '关闭后用户无法自助提交新账号，但已有供给余额和流水仍可查看。管理员绑定不受影响。',
        },
      },
